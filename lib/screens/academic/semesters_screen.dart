...
/// Shows the two semesters inside an academic year.
/// A semester opens a separate list of its subjects.
class SemestersScreen extends StatelessWidget {
  final YearData year;
  const SemestersScreen({super.key, required this.year});
          ...
          return Card(
            ...
            child: ListTile(
              ...
              onTap: () => Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (_) => SubjectsScreen(year: year, semester: semester),
                ),
              ),
            ),
          );
